...
Widget _buildApp() {
  return ProviderScope(
    overrides: [dsrRepositoryProvider.overrideWithValue(FakeDsrRepository())],
    child: MaterialApp(
...
void main() {
  testWidgets(
    'submit button is disabled when text field is empty or mistyped',
    (tester) async {
  ...
  testWidgets('submit button is enabled when text field contains exactly '
